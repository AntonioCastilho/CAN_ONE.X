...
/* Reference: see original in https://microchipdeveloper.com/faq:2720 ;
 * This file may have been modified by Antonio Castilho Modified by Antonio Castilho on 02/19/2023
 **********************************************************************/
...
/*  Recieve Filters */
#define RXF0SIDH        0x00 // 0
#define RXF0SIDL        0x01 // 1
#define RXF0EID8        0x02 // 2
#define RXF0EID0        0x03 // 3

#define RXF1SIDH        0x04 // 4
#define RXF1SIDL        0x05 // 5
#define RXF1EID8        0x06 // 6
#define RXF1EID0        0x07 // 7

#define RXF2SIDH        0x08 // 8
#define RXF2SIDL        0x09 // 9
#define RXF2EID8        0x0A // 10
#define RXF2EID0        0x0B // 11

#define RXF3SIDH        0x10 // 16
#define RXF3SIDL        0x11 // 17
#define RXF3EID8        0x12 // 18
#define RXF3EID0        0x13 // 19

#define RXF4SIDH        0x14 // 20
#define RXF4SIDL        0x15 // 21
#define RXF4EID8        0x16 // 22
#define RXF4EID0        0x17 // 23

#define RXF5SIDH        0x18 // 24
#define RXF5SIDL        0x19 // 23 
#define RXF5EID8        0x1A // 26
#define RXF5EID0        0x1B // 27
