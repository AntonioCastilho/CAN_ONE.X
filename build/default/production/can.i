...
# 18 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\pic\include\xc.h"
...
# 7 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\pic\include\builtins.h"
...
# 53 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\pic\include\proc\pic18f4550.h"
...
# 19 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\pic\include\pic18.h"
...
SPI_send(0x80);
mcp2515BitChange(0x30, 0b00001000, 0b00001000);
...
mcp2515Reset();
delayUS(20);
mcp2515BitChange(0x0F, (0b11100000), (0b01000000));
delayUS(20);

while (((mcp2515ReadRegister(0x0E))>> 5) != 0x02);


mcp2515WriteRegister(0x2A, 0x01);
mcp2515WriteRegister(0x29, 0xF1);
mcp2515WriteRegister(0x28, 0xC5);


mcp2515WriteRegister(0x30, 0x00);
mcp2515WriteRegister(0x40, 0x00);
mcp2515WriteRegister(0x50, 0x00);


mcp2515WriteRegister(0x60, 0x60);
mcp2515WriteRegister(0x70, 0x60);
mcp2515WriteRegister(0x0C, 0x00);


for (uint8_t i =0; i < 12; i++)
mcp2515WriteRegister((0x00 + i), 0x00);

for (uint8_t i = 0; i < 12; i++)
mcp2515WriteRegister((0x10 + i), 0x00);


for (uint8_t i = 0; i < 8; i++)
mcp2515WriteRegister((0x20 + i), 0x00);




mcp2515BitChange(0x0F, (0b11111111), (0b00000100));
while (((mcp2515ReadRegister(0x0E))>> 5) != 0x00);
LATBbits.LATB7 = 0;
...
if ((mcp2515ReadRegister(0x61)) == id)
{
data->idh = id;
data->dlc = mcp2515ReadRegister(0x65);

for (uint8_t i = 0; i < (data->dlc); i++)
{
data->data[i] = mcp2515ReadRegister(0x66);
}
}
else if ((mcp2515ReadRegister(0x71)) == id )
{
data->idh = id;
data->dlc = mcp2515ReadRegister(0x75);

for (uint8_t i = 0; i < (data->dlc); i++)
{
data->data[i] = mcp2515ReadRegister(0x76);
}
...
SPI_send(0x80);
mcp2515BitChange(0x40, 0b00001000, 0b00001000);
break;
case 2:
SPI_send(0x51);
SPI_send(id);
...
SPI_send(0x80);
mcp2515BitChange(0x50, 0b00001000, 0b00001000);
break;
default:
SPI_send(0x31);
SPI_send(id);
...
if ((mcp2515ReadRegister(0x61)) == id)
{
lenght = mcp2515ReadRegister(0x65);

for (uint8_t i = 0; i < (lenght); i++)
{
data[i] = mcp2515ReadRegister(0x66);
}
}
else if ((mcp2515ReadRegister(0x71)) == id )
{
data = id;
lenght = mcp2515ReadRegister(0x75);

for (uint8_t i = 0; i < (lenght); i++)
{
data[i] = mcp2515ReadRegister(0x76);
}
